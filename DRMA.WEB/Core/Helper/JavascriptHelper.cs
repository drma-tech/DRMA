...
namespace DRMA.WEB.Core.Helper
{
    ...
    public class UtilsJs(IJSRuntime js) : JsModuleBase(js, "./js/utils.js")
    {
        ...
        public Task<string?> GetBrowserName() => Invoke("environment.getBrowserName");
        public Task<string?> GetBrowserVersion() => Invoke("environment.getBrowserVersion");
        public Task<string?> GetOperatingSystem() => Invoke("environment.getOperatingSystem");
