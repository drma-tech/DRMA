...
{
    options.Dsn = "https://9d67a029559a76d507d4437b586e778f@o4510938040041472.ingest.us.sentry.io/4510942795005952";
    ...
    {
        evt.Release = $"drma-web@{AppStateStatic.Version}";
...
{
    builder.RootComponents.Add<DRMA.WEB.App>("#app");
